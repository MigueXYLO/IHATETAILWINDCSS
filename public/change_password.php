                        ...
                        <div class="max-w-xl">
                            <section>
                                ...
                                <form method="post" action="#" class="mt-6 space-y-6">
                                    <div>
                                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="update_password_current_password">
                                            Current Password
                                        </label>
                                        <input class="bg-white dark:bg-gray-900 text-black dark:text-gray-50
                                            border-gray-300 dark:border-gray-700 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 rounded-md shadow-sm mt-1 block w-full" id="update_password_current_password" name="current_password" type="password">
                                    ...
                                    <div>
                                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="update_password_password">
                                            New Password
                                        </label>
                                        <input class="bg-white dark:bg-gray-900 text-black dark:text-gray-50
                                            border-gray-300 dark:border-gray-700 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 rounded-md shadow-sm mt-1 block w-full" id="update_password_password" name="password" type="password">
                                    </div>

                                    <div>
                                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="update_password_password_confirmation">
                                            Confirm Password
                                        </label>
                                        <input class="bg-white dark:bg-gray-900 text-black dark:text-gray-50
                                            border-gray-300 dark:border-gray-700 focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 rounded-md shadow-sm mt-1 block w-full" id="update_password_password_confirmation" name="password_confirmation" type="password">
                                    </div>
