...
$dataTest = filterDisciplines($disciplines, 3, 2);
...
<body class="font-sans antialiased">
                    ...
                    <div id="menu" class="grow flex flex-col sm:flex-row items-stretch
                        ...
                        <div class="relative sm:static group flex flex-col me-0 sm:me-2">
                            ...
                            <div id="submenu_curricula" class="z-40 w-full items-center 
                                ...
                                <a class="px-2 py-4 border-b-2 border-indigo-400 dark:border-indigo-500 text-sm font-medium leading-5 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-indigo-700 dark:focus:border-indigo-300 focus:border-gray-300 dark:focus:border-gray-700"
                                   href="./curricula.php?course=<?= $c->abbreviation ?>">
                                    <?php else : ?>
                                    <a class="px-2 py-4 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-700 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:border-gray-300 dark:focus:border-gray-700 focus:text-gray-700 dark:focus:text-gray-300"
                                       href="./curricula.php?course=<?= $c->abbreviation ?>">
                                        <?php endif; ?>
        ...
        <header class="bg-white dark:bg-gray-900 shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                ...
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                    Curriculum of <?php echo(courseFullName($course->name, $course->type)) ?>
                </h2>
            </div>
        </header>
 ...
 rowspan='{$biggestTotal}'>{$year}</th>";
                                    ...
                                    for ($n = 1; $n <= 2; $n++) {
                                        ...
                                        //if discName is '' create a blank cell with a rowspan of what's left and moves on
                                        if ($discName == '') {

                                        }else{
                                            if ($i == ($biggestTotal - 1)) {
                                                // Last line of the year
                                                $linha = "<td class='border border-b-2 border-b-gray-400
                                             dark:border-b-gray-500 py-1 px-3 border-e-2
                                             border-e-gray-400 dark:border-e-gray-500'>
                                             {$discName }</td>";
                                            } else {
                                                // Other lines
                                                $linha = "<td class='border border-b-gray-300
